...
* Получение списков обучающихся по курсам:
    * На странице компаний(главной странице) выбираем нужную компанию, проводящую курс
    * Нажимаем на кнопку "Курсы"
    * На странице данной компании выбираем нужный курс
    * Нажимаем на кнопку "Подробнее"
    * На странице курс листаем вниз до списка слушателей
* Получении истории обучения для данного человека:
    * На любой странице выбираем слева в меню иконку человека, попадаем на страницу со слушателями
    * Находим на странице нужного слушателя(например через поиск, или вручную)
    * Нажимаем на его ФИО, попадем на личную страницу данного слушателя
    * В разделе курсы в выпадающем списке выбираем "Пройдены"
* Получение списка преподавателей:
    * На любой странице выбираем слева в меню иконку очков, попадаем на страницу с преподавателями
* Получение списка преподавателей по проводимым курсам:
    * На странице компаний(главной странице) выбираем нужную компанию, проводящую курс
    * Нажимаем на кнопку "Курсы"
    * На странице данной компании выбираем нужный курс
    * Нажимаем на кнопку "Подробнее"
    * На странице курс листаем вниз до списка преподавателей
* Получение расписания на заданный интервал времени для обучающегося:
    * На любой странице выбираем слева в меню иконку человека, попадаем на страницу со слушателями
    * Находим на странице нужного слушателя(например через поиск, или вручную)
    * Нажимаем на его ФИО, попадем на личную страницу данного слушателя
    * В разделе расписание в выпадающем списке выбираем нужный интервал
* Получение расписания на заданный интервал времени для преподавателя:
    * На любой странице выбираем слева в меню иконку очков, попадаем на страницу с преподавателями
    * Находим на странице нужного преподавателя(например через поиск, или вручную)
    * Нажимаем на его ФИО, попадем на личную страницу данного преподавателя
    * В разделе расписание в выпадающем списке выбираем нужный интервал
* Составление расписания занятий для курса:
    ...
    * На странице данной компании выбираем нужный курс
    * Нажимаем на кнопку "Подробнее"
    * На странице курс листаем вниз до раздела расписание
    * В выпадающем списке выбираем нужный интервал
    * Нажимаем на "карандаш" для редактирования расписания
* Добавление обучающихся/преподавателей:
    * На любой странице выбираем слева в меню иконку человека/очков, попадаем на страницу со слушателями/преподавателями
    * Нажимаем на кнопку с плюсом в шапке страницы
    * Заполняем форму данными слушателя/преподавателя
    * Нажимаем сохранить
* Удаление обучающихся/преподавателей:
    * На любой странице выбираем слева в меню иконку человека/очков, попадаем на страницу со слушателями/преподавателями
    * Находим на странице нужного слушателя/преподавателя(например через поиск, или вручную)
    * Нажимаем на "мусорную корзину" рядом с ФИО
* Чтение и редактирование данных об обучающихся/преподавателях:
    * На любой странице выбираем слева в меню иконку человека/очков, попадаем на страницу со слушателями/преподавателями
    * Находим на странице нужного слушателя/преподавателя(например через поиск, или вручную)
    * Нажимаем на его ФИО, попадем на личную страницу данного слушателя/преподавателя
    * Если нужно отредактировать данные, нажимаем на "карандаш" рядом с полем
* Занесение обучающегося в список слушателей курса:
    * На странице компаний(главной странице) выбираем нужную компанию, проводящую курс
    * Нажимаем на кнопку "Курсы"
    * На странице данной компании выбираем нужный курс
    * Нажимаем на кнопку "Подробнее"
    * На странице курс листаем вниз до раздела списка слушателей
    * Нажимаем на плюс
    * В открывшемся окне находим нужного студента
    * Нажимаем сохранить
* Добавление курса
    * На странице компаний(главной странице) выбираем нужную компанию, проводящую курс
    * Нажимаем на кнопку "Курсы"
    * Нажимаем на кнопку с плюсом
...
* Удаление курса
    ...
    * Нажимаем на кнопку "Курсы"
    * На странице данной компании выбираем нужный курс
    * Нажимаем на "мусорную корзину" рядом с кнопкой "подробнее"
* Чтение и редактирование данных о курсе
    * На странице компаний(главной странице) выбираем нужную компанию, проводящую курс
    * Нажимаем на кнопку "Курсы"
    * На странице данной компании выбираем нужный курс
    * Нажимаем на кнопку "Подробнее"
